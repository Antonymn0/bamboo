...
class LeaveUnderReviewNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->action('Your leave request has been put on hold and is under review.', url('/'))
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'notification_sub_type' => 'leave_under_review',
