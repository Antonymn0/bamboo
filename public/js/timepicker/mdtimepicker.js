...
+(function ($) {
  ...
  MDTimePicker.prototype = {
    ...
    setT: function (value) {
      ...
      this.timepicker.timeHolder.am_pm.text(t === "ق.ظ" ? "AM" : "PM");
      this.timepicker.clockHolder.am[t === "ق.ظ" ? "addClass" : "removeClass"](
        "active"
      );
      this.timepicker.clockHolder.pm[t === "ب.ظ" ? "addClass" : "removeClass"](
        "active"
      );
    },
