        ...
        <div class="container">
            <div class="section">
                <h1> 
                    ...
                    {{settings ? getSetting('onboarding_page_three_title',settings).value ? getSetting('onboarding_page_three_title',settings).value : 'New Employee' : 'New Employee'}}
                </h1>
            </div>
        <div class="tab-pane-content">
            ...
            <form @submit.prevent="save" class="border">
                <h1 class="title-border mb-3 pb-2"> 
                    ...
                    {{settings ? getSetting('onboarding_page_three_sub_title',settings).value ? getSetting('onboarding_page_three_sub_title',settings).value : 'Assign Tasks' : 'Assign Tasks'}}
                ...
                <Tasks :employee="newEmployee" :formFields="formFields" />

                
                <div class="flex items-center justify-end mt-3">
                    <Link :href="route('onboard.step.two',newEmployee.username)" class="btn btn-sm btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>
                    <BreezeButton id="submit" class="ml-4" :class="{ 'opacity-25': processing || Object.keys(errors).length }" :disabled="processing || Object.keys(errors).length">
...
export default {
    ...
    data: function(){
      return{
          name:this.newEmployee.name ? this.newEmployee.name : '',
        ...
        save(){
            ...
            /*axios({
                ...
                data: {
                   ...
                   // alert( "A link has been sent to "+this.newEmployee.name+" that will allow registration to continue" )
