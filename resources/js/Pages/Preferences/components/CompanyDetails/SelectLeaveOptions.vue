...
<app-header title="Preferences" subtitle="Leave options"  />
            ...
            <div class="row">
                ...
                <div class="col-md-9 py-3">                   
                    ...
                    <div class="text-center border-top pt-2 ">
                        <Link :href="route('preferences.company-details.departments', company.id)" class="btn btn-secondary submit px-2 "> <span class="fa fa-chevron-left"></span> Back</Link>
...
import LeaveOptions from '../Leave/LeaveOptionsComponent.vue';
