<template>
    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                <nav>
                    <Tabs :active="4" :user="newEmployee" />
                </nav>
                ...
                <div class="tab-pane-content">
                    ...
                    <form action="">
                        <WorkExperience :showVerifyBox="true" :permissions="permissions" :settings="settings" :user="newEmployee" />
                        <Referees :showVerifyBox="true" :permissions="permissions" :settings="settings" :user="newEmployee" />
                    </form>

                    <form class="border-top pt-2 pb-2 bg-light" id="submit-form" >
                        
                        <Link :href="route('newuser.education.details',newEmployee.username)" class="btn btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                        <Link :href="route('newuser.dependants.details',newEmployee.username)" class="btn btn-theme ml-4 ">Next Page</Link>
