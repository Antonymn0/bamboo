<template>
    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                <nav>
                    <Tabs :active="2" :user="newEmployee" />
                </nav>
                ...
                <div class="tab-pane-content">
                    ...
                    <form action="">
                        <Contact  :permissions="permissions" :settings="settings" :user="newEmployee" />
                        <Address  :permissions="permissions" :settings="settings" :user="newEmployee" />
                    </form>

                    <form class="border-top pt-2 pb-2 bg-light" id="submit-form" >
                        
                        <Link :href="route('newuser.basic.details',newEmployee.username)" class="btn btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                        <Link :href="route('newuser.education.details',newEmployee.username)" class="btn btn-theme ml-4 ">Next Page</Link>
...
import Contact from '../../Components/Profile/Sections/Contact.vue';
