            ...
            <div class="col-9">
                ...
                <div class="tab-pane-content">
                    ...
                    <form class="border-top pt-2 pb-2 bg-light" id="submit-form" >
                        ...
                        <Link :href="route('newuser.beneficiaries.details',newEmployee.username)" class="btn btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                        <Link :href="route('newuser.payment.details',newEmployee.username)" class="btn btn-theme ml-4 ">Next Page</Link>
