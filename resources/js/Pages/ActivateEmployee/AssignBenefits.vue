<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="tab-pane-content">
            ...
            <form @submit.prevent="activateUser" class="border">
                <h1 class="title-border mb-3 pb-2"> 
                    <small class="fa fa-money-bill-wave"></small>
                    Assign Benefits
                 </h1>
                ...
                <AssignBenefits :employee="newEmployee" :formFields="formFields" />
                ...
                <div class="flex items-center justify-end mt-3">
                    <BreezeButton id="submit" class="ml-4" :class="{ 'opacity-25': processing || Object.keys(errors).length }" :disabled="processing || Object.keys(errors).length">
                       <span v-if="processing" class="fa fa-spinner fa-spin"></span>&nbsp; Finish 
                    </BreezeButton>
                </div>
            </form>
</div>
...
import AssignBenefits from '@/Components/Onboarding/AssignBenefits.vue';
...
export default {
    ...
    methods:{
        ...
        activateUser(){
            ...
            axios({
                method: 'PUT',
                url: '/v1/user-activate/'+this.newEmployee.id,
                data: {
