    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <nav>
                   <Tabs :active="6" :employee="newEmployee" :link="'/employee/registration/'+newEmployee.username" />
                </nav>
                ...
                <Link :href="'/employee/registration/'+newEmployee.username+'?step=5'" class="btn btn-sm btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                    <Link :href="'/employee/registration/'+newEmployee.username+'?step=7'" class="btn  btn-sm btn-theme submit">Next Page</Link>
