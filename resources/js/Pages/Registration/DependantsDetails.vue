    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <Link :href="'/employee/registration/'+newEmployee.username+'?step=4'" class="btn btn-sm btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                    <Link :href="'/employee/registration/'+newEmployee.username+'?step=6'" class="btn btn-sm btn-theme submit">Next Page</Link>
