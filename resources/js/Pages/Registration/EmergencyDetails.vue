    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <nav>
                   <Tabs :active="7" :employee="newEmployee" :link="'/employee/registration/'+newEmployee.username" />
                </nav>
                ...
                <Link :href="'/employee/registration/'+newEmployee.username+'?step=6'" class="btn btn-sm btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                <!--<Link @click.prevent="save()" class="ml-4 btn btn-theme" :class="{ 'opacity-25': processing }" :disabled="processing">
                    Submit
                </Link>-->
                    <Link :href="'/employee/registration/'+newEmployee.username+'?step=8'" class="btn btn-sm btn-theme submit">Next Page</Link>
