<template>
    ...
    <div class="container-fluid profile">
        <div class="row">
            ...
            <div class="col-9">
                <nav>
                   <Tabs :active="4" :employee="newEmployee" :link="'/employee/registration/'+newEmployee.username" />
                </nav>
                <div class="tab-pane-content"  >
                    
                    <form action="">
                        <WorkExperience :user="newEmployee" />
                        <Referees :user="newEmployee" />
                    </form>

                <form class="border-top p-2 bg-light" id="submit-form" :action="route('employee.submit',newEmployee.username)">
                    <Link :href="'/employee/registration/'+newEmployee.username+'?step=3'" class="btn btn-sm btn-secondary mr-4"> <span class="fa fa-chevron-left"></span> Back</Link>

                    <Link :href="'/employee/registration/'+newEmployee.username+'?step=5'" class="btn btn-sm btn-theme submit">Next Page</Link>
