<template>
    ...
    <div class="material-textfield">
      <input v-model="value" class="form-control bg-white" :readonly="readonly" :type="type" :name="name" :class="[error ? '' : '', classes ? classes : '']" :id="id" :placeholder="placeholder" @input="save" @change="change"  @blur="save" :required="required" />
