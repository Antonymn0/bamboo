<template>
  <div class="panel">
      <div class="material-textfield">
        <textarea v-model="value" class="form-control bg-white" :readonly="readonly" :name="name" :class="classes" :id="id" :placeholder="placeholder" @textarea="save" @change="change"  @blur="save" :required="required"></textarea>
